        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            @if($reservas->isEmpty())
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-semibold text-gray-900">No hay reservas</h3>
                    <p class="mt-1 text-sm text-gray-500">Todavía no se han realizado reservas.</p>
                </div>
            @else
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-900">Observaciones</th>
                            </tr>
                        </thead>
                            ...
                            @foreach($reservas as $reserva)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                        ...
                                        <span class="text-gray-500">({{ substr($reserva->turno->hora_inicio, 0, 5) }})</span>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                        ...
                                        <div class="text-gray-500">{{ $reserva->user->email }}</div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                        {{ $reserva->comensales }}
                                    </td>
